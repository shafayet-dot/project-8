...
const BookCrad = ({handleDelete,displayPhones}) => {
  ...
  >
...

    {
        ...
        favorites.length == 0 ?<div className='flex justify-center w-full mb-96'><h1 className=' mt-10  h-40  border border-gray-300 rounded-lg shadow-md bg-white justify-center text-center items-center font-bold text-3xl p-50'>No Lawyar appoinment here</h1></div> 
        :
      favorites.map(fav=>
